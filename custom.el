...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ob-clojurescript ob-http org-bullets js2-refactor xref-js2 js2-mode ob-typescript ob-javascript htmlize shackle dockerfile-mode cider mode-icons emmet-mode web-mode markdown-mode haml-mode yaml-mode define-word powerthesaurus flyspell-correct-popup flyspell-correct company shell-pop git-gutter magit counsel-projectile ivy-rich avy flx smex counsel swiper ivy projectile multiple-cursors visual-regexp move-text expand-region which-key vi-tilde-fringe neotree rich-minority smartparens all-the-icons undo-tree simpleclip exec-path-from-shell use-package)))
